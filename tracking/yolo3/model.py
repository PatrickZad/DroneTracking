...
from tracking.yolo3.utils import compose
...
def preprocess_true_boxes(true_boxes, input_shape, anchors, num_classes):
    ...
    boxes_xy = true_boxes[..., 0:2] + true_boxes[..., 2:4] // 2  # box center
    boxes_wh = true_boxes[..., 2:4]
    true_boxes[..., 0:2] = boxes_xy / input_shape[::-1]  # between (0,1)
    ...
    y_true = [np.zeros((m, grid_shapes[l][0], grid_shapes[l][1], len(anchor_mask[l]),
                        5 + num_classes), dtype='float32') for l in
              range(3)]  # batch_size * grid_h * grid_w * scale_anchors * (num_class+5)
        ...
        for t, n in enumerate(best_anchor):
            for l in range(3):
                if n in anchor_mask[l]:
                    ...
                    y_true[l][b, j, i, n, 4] = 1  # objectness or score
                    y_true[l][b, j, i, n, 5 + c] = 1  # class one-hot
                    break
